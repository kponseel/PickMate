...
static const QA QUESTIONS[] = {
    ...
    {"Combien de pattes a une etoile de mer typique ?",          "Cinq"},
    {"Quel est le nom de la phobie des araignees ?",             "Arachnophobie"},
    {"Quel pays a le plus de fuseaux horaires ?",                "France"},
    {"Comment s'appelle le bebe d'un kangourou ?",               "Joey"},
    {"Quel est l'element chimique de symbole Au ?",              "Or"},
    {"Quel est le plus grand pays d'Amerique du Sud ?",          "Bresil"},
    {"Qui a invente le telephone ?",                             "Bell"},
    {"Quel est le plus petit os du corps humain ?",              "L'etrier"},
    {"Quel est l'oiseau qui ne peut pas voler ET nage ?",        "Manchot"},
    {"Quel est l'instrument national de l'Inde ?",               "Sitar"},
    {"En quelle annee est sorti le premier Mario ?",             "1985"},
    {"Quel est le plus petit pays du monde ?",                   "Vatican"},
    {"Combien de couleurs a l'arc-en-ciel ?",                    "Sept"},
};
