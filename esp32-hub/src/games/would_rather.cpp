...
static const Pair PROMPTS[] = {
    ...
    {"Plus jamais de cafe",                    "Plus jamais de chocolat"},
    {"Mer",                                    "Montagne"},
    {"Chat",                                   "Chien"},
    {"Etre celebre",                           "Etre riche anonyme"},
    {"Perdre tes photos",                      "Perdre tes contacts"},
    {"Lire toutes les pensees autour",         "Que tout le monde lise les tiennes"},
    {"Vacances eternelles sans amis",          "Boulot ideal entoure d'amis"},
    {"Pas de telephone pendant 1 an",          "Pas de TV/streaming pendant 1 an"},
    {"Vivre dans une mega-ville",              "Vivre sur une ile deserte"},
    {"Etre l'expert mondial d'un sujet inutile","Etre moyen sur tout"},
    {"Eternellement 5 ans",                    "Eternellement 70 ans"},
    {"Voir tes amis 1 fois par mois",          "Vivre avec eux H24"},
    {"Marcher 5km tous les jours",             "Manger fade tous les jours"},
    {"Toujours dire la verite",                "Ne plus jamais mentir mais ne pas savoir te taire"},
    {"Connaitre le jour de ta mort",           "Connaitre la cause"},
};
